...
vino_core_lib::ObjectSegmentationMaskrcnnResult::ObjectSegmentationMaskrcnnResult(const cv::Rect &location)
    : Result(location)
{
}

// ObjectSegmentation
vino_core_lib::ObjectSegmentationMaskrcnn::ObjectSegmentationMaskrcnn(double show_output_thresh)
    : show_output_thresh_(show_output_thresh), vino_core_lib::BaseInference()
{
}

vino_core_lib::ObjectSegmentationMaskrcnn::~ObjectSegmentationMaskrcnn() = default;

void vino_core_lib::ObjectSegmentationMaskrcnn::loadNetwork(
 ...
 */
bool vino_core_lib::ObjectSegmentationMaskrcnn::enqueue_for_one_input(
    const cv::Mat &frame,
...
bool vino_core_lib::ObjectSegmentationMaskrcnn::enqueue(
    const cv::Mat &frame,
    const cv::Rect &input_frame_loc)
{
  if (width_ == 0 && height_ == 0)
...
bool vino_core_lib::ObjectSegmentationMaskrcnn::submitRequest()
{
  return vino_core_lib::BaseInference::submitRequest();
}

bool vino_core_lib::ObjectSegmentationMaskrcnn::fetchResults()
{
...
int vino_core_lib::ObjectSegmentationMaskrcnn::getResultsLength() const
{
  return static_cast<int>(results_.size());
}

const vino_core_lib::Result *
vino_core_lib::ObjectSegmentationMaskrcnn::getLocationResult(int idx) const
{
  return &(results_[idx]);
}

const std::string vino_core_lib::ObjectSegmentationMaskrcnn::getName() const
{
  return valid_model_->getModelCategory();
}

void vino_core_lib::ObjectSegmentationMaskrcnn::observeOutput(
...
const std::vector<cv::Rect> vino_core_lib::ObjectSegmentationMaskrcnn::getFilteredROIs(
