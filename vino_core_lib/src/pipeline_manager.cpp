...
PipelineManager::createFaceDetection(
  ...
  auto face_inference_ptr = std::make_shared<vino_core_lib::FaceDetection>(
...
const Params::ParamManager::InferenceParams & infer)
{
  ...
  auto object_inference_ptr = std::make_shared<vino_core_lib::ObjectDetection>(
...
PipelineManager::createObjectSegmentation(const Params::ParamManager::InferenceParams & infer)
{
  ...
  auto segmentation_inference_ptr = std::make_shared<vino_core_lib::ObjectSegmentation>(0.5);
