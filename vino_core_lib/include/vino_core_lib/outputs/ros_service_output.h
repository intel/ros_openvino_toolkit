...
#ifndef VINO_CORE_LIB__OUTPUTS__ROS_SERVICE_OUTPUT_H
#define VINO_CORE_LIB__OUTPUTS__ROS_SERVICE_OUTPUT_H
...
public:
  ...
  void init(const std::string& pipeline_name) override {pipeline_name_ = pipeline_name;};
...
#endif  // VINO_CORE_LIB__OUTPUTS__ROS_SERVICE_OUTPUT_H
