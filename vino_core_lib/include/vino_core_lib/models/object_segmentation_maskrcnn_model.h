 ...
 */
#ifndef VINO_CORE_LIB__MODELS__OBJECT_SEGMENTATION_MASKRCNN_MODEL_H
#define VINO_CORE_LIB__MODELS__OBJECT_SEGMENTATION_MASKRCNN_MODEL_H
#include <string>
 ...
 * @brief This class generates the object segmentation maskrcnn model.
 */
...
#endif  // VINO_CORE_LIB__MODELS__OBJECT_SEGMENTATION_MASKRCNN_MODEL_H