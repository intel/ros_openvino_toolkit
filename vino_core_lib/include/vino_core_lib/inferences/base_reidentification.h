 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_H
#define VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_H
#include <vector>
#include <cmath>
#include <string>
#include <thread>
...
#endif  // VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_H
