...
static const char face_detection_model_message[] =
    "Required. Path to an .xml file with a trained face detection "
    "model.";
...
static const char object_model_message[] =
...
static const char target_device_message_ag[] =
    "Specify the target device for Age Gender Detection (CPU, GPU, FPGA, or "
    "MYRIAD). "
    "Sample will look for a suitable plugin for device specified.";

/// @brief message for assigning age gender calculation to device
static const char target_device_message_hp[] =
    "Specify the target device for Head Pose Detection (CPU, GPU, FPGA, or "
    "MYRIAD). "
    "Sample will look for a suitable plugin for device specified.";

static const char target_device_message_em[] =
    "Specify the target device for Emotions Detection (CPU, GPU, FPGA, or "
    "MYRIAD). "
    "Sample will look for a suitable plugin for device specified.";

/// @brief message for number of simultaneously age gender detections using
/// dynamic batch
static const char num_batch_ag_message[] = "Specify number of maximum "
                                           "simultaneously processed faces for "
                                           "Age Gender Detection"
                                           "(default is 16).";

/// @brief message for number of simultaneously age gender detections using
/// dynamic batch
static const char num_batch_hp_message[] = "Specify number of maximum "
                                           "simultaneously processed faces for "
                                           "Head Pose Detection"
                                           "(default is 16).";
...
/// @brief message for number of simultaneously age gender detections using
/// dynamic batch
static const char num_batch_em_message[] = "Specify number of maximum "
                                           "simultaneously processed faces for "
                                           "Emotions Detection"
                                           "(default is 16).";
...
static const char custom_cldnn_message[] =
    "Required for clDNN (GPU)-targeted custom kernels."
...
static const char no_wait_for_keypress_message[] =
    "No wait for key press in the end.";
...
static const char input_file_path[] =
    "Optional. Path to a video or image file.";

/// @brief message absolute path of parameter config file
static const char parameter_file_message[] =
    "Absolute path of parameter config file.";
