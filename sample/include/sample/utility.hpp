...
static const char num_batch_ag_message[] =
    "Specify number of maximum simultaneously processed faces for Age Gender "
    "Detection"
    "(default is 16).";
...
static const char num_batch_hp_message[] =
    "Specify number of maximum simultaneously processed faces for Head Pose "
    "Detection"
    "(default is 16).";
...
static const char num_batch_em_message[] =
    "Specify number of maximum simultaneously processed faces for Emotions "
    "Detection"
    "(default is 16).";
...
static void showUsage() {
  ...
  std::cout << "    -i_path                    " << input_file_path <<
std::endl;
  std::cout << "    -m \"<path>\"                "
