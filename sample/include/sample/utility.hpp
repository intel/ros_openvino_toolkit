...
static const char target_device_message_ag[] = "Specify the target device for Age Gender Detection (CPU, GPU, FPGA, or "
                                               "MYRIAD). "
                                               "Sample will look for a suitable plugin for device specified.";

/// @brief message for assigning age gender calculation to device
static const char target_device_message_hp[] = "Specify the target device for Head Pose Detection (CPU, GPU, FPGA, or "
                                               "MYRIAD). "
                                               "Sample will look for a suitable plugin for device specified.";

static const char target_device_message_em[] = "Specify the target device for Emotions Detection (CPU, GPU, FPGA, or "
                                               "MYRIAD). "
                                               "Sample will look for a suitable plugin for device specified.";
