...
public:
  ...
  /**
   * @brief Generate output content according to the license plate detection
   * result.
   */
  virtual void
  accept(const std::vector<dynamic_vino_lib::LicensePlateDetectionResult> &) {}
  /**
   * @brief Generate output content according to the vehicle attributes
   * detection result.
   */
  virtual void
  accept(const std::vector<dynamic_vino_lib::VehicleAttribsDetectionResult> &) {
  }
  /**
  * @brief Generate output content according to the person atrribute detection
  * result.
  */
  virtual void
  accept(const std::vector<dynamic_vino_lib::PersonAttribsDetectionResult> &) {}
  /**
  * @brief Generate output content according to the face reidentification
  * result.
  */
  virtual void
  accept(const std::vector<dynamic_vino_lib::FaceReidentificationResult> &) {}
  /**
   * @brief Generate output content according to the landmarks detection result.
   */
  virtual void
  accept(const std::vector<dynamic_vino_lib::LandmarksDetectionResult> &) {}
  /**
  * @brief Generate output content according to the face detection result.
  */
  virtual void
  accept(const std::vector<dynamic_vino_lib::ObjectDetectionResult> &) {}
  /**
   * @brief Generate output content according to the face detection result.
   */
  virtual void
  accept(const std::vector<dynamic_vino_lib::FaceDetectionResult> &) {}
  /**
   ...
   */
  virtual void
  accept(const std::vector<dynamic_vino_lib::ObjectSegmentationResult> &) {}
  /**
  * @brief Generate output content according to the person reidentification
  * result.
  */
  virtual void
  accept(const std::vector<dynamic_vino_lib::PersonReidentificationResult> &) {}
  /**
  ...
  virtual void setServiceResponse(
      boost::shared_ptr<object_msgs::DetectObjectRequest> response) {}
