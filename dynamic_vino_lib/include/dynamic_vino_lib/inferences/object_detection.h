...
public:
  ...
  void setConfidence(const float &con) { confidence_ = con; }
...
private:
   ...
   */
  static bool isValidLabel(const Result &result, const std::string &op,
   ...
   * @return True if valid, false if not.
   */
  static bool isValidConfidence(const Result &result, const std::string &op,
                                const std::string &target);
