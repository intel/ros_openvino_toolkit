...
void Outputs::RosServiceOutput::setServiceResponse(
  ...
  if (segmented_objects_topic_ != nullptr) {
    response->segmentation.objects_vector =
        segmented_objects_topic_->objects_vector;
  }
}
void Outputs::RosServiceOutput::setServiceResponse(
  ...
  if (person_reid_topic_ != nullptr) {
    response->reidentification.reidentified_vector =
