...
// Tracker
dynamic_vino_lib::Tracker::Tracker(int max_record_size, double same_track_thresh, double new_track_thresh)
...
double dynamic_vino_lib::Tracker::findMostSimilarTrack(const std::vector<float>& feature, int& most_similar_id)
{
...
double dynamic_vino_lib::Tracker::calcSimilarity(const std::vector<float>& feature_a,
                                                 const std::vector<float>& feature_b)
{
  if (feature_a.size() != feature_b.size())
  {
    slog::err << "cosine similarity can't be called for vectors of different "
                 "lengths: "
...
void dynamic_vino_lib::Tracker::updateMatchTrack(int track_id, const std::vector<float>& feature)
{
