...
bool dynamic_vino_lib::BaseFilter::isValidFilterConditions(const std::string& filter_conditions)
{
  return strip(filter_conditions) != "";
}

void dynamic_vino_lib::BaseFilter::acceptFilterConditions(const std::string& filter_conditions)
{
...
bool dynamic_vino_lib::BaseFilter::isPriorTo(const std::string& operator1, const std::string& operator2)
{
...
const std::vector<std::string>& dynamic_vino_lib::BaseFilter::getSuffixConditions() const
{
  return suffix_conditons_;
}

bool dynamic_vino_lib::BaseFilter::logicOperation(const std::string& logic1, const std::string& op,
...
bool dynamic_vino_lib::BaseFilter::stringCompare(const std::string& candidate, const std::string& op,
...
bool dynamic_vino_lib::BaseFilter::floatCompare(float candidate, const std::string& op, float target)
{
  if (!op.compare("<="))
  {
...
std::vector<std::string> dynamic_vino_lib::BaseFilter::split(const std::string& filter_conditions)
{
...
void dynamic_vino_lib::BaseFilter::infixToSuffix(std::vector<std::string>& infix_conditions)
{
